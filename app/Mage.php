...
final class Mage
{
	...
	public static function checkLoginMethod($login){
		
		$email=self::getModel("customer/customer")->getCollection()
		->addAttributeToFilter("email",array("eq"=>$login))->getSize();
		
		$telephone=self::getModel("customer/customer")->getCollection()
		->addAttributeToFilter("telephone",array("eq"=>$login))->getSize();

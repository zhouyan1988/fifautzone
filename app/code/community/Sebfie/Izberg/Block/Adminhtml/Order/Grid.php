<?php
class Sebfie_Izberg_Block_Adminhtml_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid {

	protected $_withGrid = true;

    public function __construct() {
        parent::__construct();
        $this->setId('sales_izberg_order_grid');
    ...
    protected function _prepareCollection() {
        ...
        $collection->addAttributeToFilter('main_table.is_izberg_external_order', array('gt' => 0));
        if(!$this->_withGrid) {
    ...
    protected function _prepareColumns() {
        ...
        // Add datas from Iceberg
        $this->addColumn('izberg_external_order_id', array(
            'header' => Mage::helper('izberg')->__('Id izberg'),
            'index' => 'izberg_external_order_id',
        ));

        // End datas from Iceberg

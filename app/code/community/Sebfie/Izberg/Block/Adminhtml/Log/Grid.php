...
class Sebfie_Izberg_Block_Adminhtml_Log_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('izberg/log')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('level', array(
          ...
          'index'     => 'level',
          "type"      => 'options',
          "options"   => Sebfie_Izberg_Model_Log::getLevelsAsArray()
        ));

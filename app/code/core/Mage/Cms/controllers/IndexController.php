...
class Mage_Cms_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction($coreRoute = null)
    {
		...
		// $update=$this->getLayout()->getUpdate()->getHandles();
		
		 // $updates=$this->getLayout()->getUpdate()->asArray();
	    ...
	    public function testAction()
    {
		...
		$update=$this->getLayout()->getBlock("root")->getTemplate();
     ...
     public function sendSmsAction()
    {
		...
		$mobile=$request->getPost("telephone");
		
		if(empty($mobile)){
			echo "telehone is null!";die();
		}
		
		$session=Mage::getSingleTon("core/session");
		
		
		$sms_helper=Mage::helper("core/sms");
 
		//$sms_helper->sendMessage($mobile,$code);
		
		$session->setSmsCode($code);

...
class Mage_Checkout_Block_Cart_Totals extends Mage_Checkout_Block_Cart_Abstract
{
    ...
    public function renderTotal($total, $area = null, $colspan = 1)
    {
		...
		$data=$this->_getTotalRenderer($code)
            ->setTotal($total)
            ->setColspan($colspan)
    ...
    public function renderTotals($area = null, $colspan = 1)
    {
	    ...
	    public function renderOriginTotals($area = null, $colspan = 1)
    {
...
$productPrice=$this->helper('checkout')->formatPrice($productPrice);
...
return "<tr>
    ...
    <td style='' class='a-right'>
        <span class='price'>$productPrice</span></td>
</tr>";

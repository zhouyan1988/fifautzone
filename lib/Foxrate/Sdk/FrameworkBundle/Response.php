<?php
class Foxrate_Sdk_FrameworkBundle_Response
{
    public $headers;
    ...
    {
        $this->headers = new Foxrate_Sdk_FrameworkBundle_ResponseHeaderBag($headers);
    ...
    {
        return new Foxrate_Sdk_FrameworkBundle_Response($content, $status, $headers);
    }

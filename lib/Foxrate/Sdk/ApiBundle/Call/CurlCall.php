 ...
 *
 */
abstract class Foxrate_Sdk_ApiBundle_Call_CurlCall implements Foxrate_Sdk_ApiBundle_Call_ApiCallInterface
{
    protected $url;
    protected $name;
    ...
    {
        $class = get_class($this);
        throw new Exception("Class $class must implement method 'makeRequest'.");
    }

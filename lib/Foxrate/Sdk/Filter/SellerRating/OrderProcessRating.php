<?php
class Foxrate_Sdk_Filter_SellerRating_OrderProcessRating implements Foxrate_Sdk_Interface_Filter
{
    private $filterCriteria;

    private $fieldName = Foxrate_Sdk_Constants_FieldName_SellerRating::ORDER_PROCESS_RATING;

<?php
class Foxrate_Sdk_Filter_CumulativeChannel_State implements Foxrate_Sdk_Interface_Filter
{
    private $filterCriteria;

    private $fieldName = Foxrate_Sdk_Constants_FieldName_CumulativeChannel::STATE;

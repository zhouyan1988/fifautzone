<?php
class Foxrate_Sdk_Filter_ProductReview_PriceRating implements Foxrate_Sdk_Interface_Filter
{
    private $filterCriteria;

    private $fieldName = Foxrate_Sdk_Constants_FieldName_ProductReview::PRICE_RATING;

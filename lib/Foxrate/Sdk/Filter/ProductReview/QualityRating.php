<?php
class Foxrate_Sdk_Filter_ProductReview_QualityRating implements Foxrate_Sdk_Interface_Filter
{
    private $filterCriteria;

    private $fieldName = Foxrate_Sdk_Constants_FieldName_ProductReview::QUALITY_RATING;
